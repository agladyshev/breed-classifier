...
This is a study project from Udacity Deep Learning Nanodegree. 
In this project, I have built a pipeline that can be used within a web or mobile app to process real-world, user-supplied images. Given an image of a dog, this algorithm will identify an estimate of the canine’s breed. If supplied an image of a human, the code will identify the resembling dog breed.
I've also built a [telegram bot]https://github.com/agladyshev/dog_breed_bot) which utilizes this algorytihm and provide more fun and clean user experience.

## Project Instructions

### To check out complete notebook

1. Clone the repository and navigate to the downloaded folder.
```	
git clone https://github.com/agladyshev/dog-project.git
cd dog-project
```
